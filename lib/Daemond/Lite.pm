...
our $D;
our @FIELDS = qw(env src opt cfg def cf slot caller logconfig cli pid config_file score startup shutdown dies forks chld chpipes chpipe is_parent this options detached watchers log_level);
sub log : method { $log }
...
sub log_level { $_[0]{log_level} || $Daemond::Lite::Log::logging_methods{trace} }
